...
namespace BinaryTreeExample
{
    ...
    class Program
    {
        public static TreeNode Connect(TreeNode root)
        {
            ...
            root.LeftNode.NextNode = root.RightNode;
            if (root.NextNode != null)
                root.RightNode.NextNode = root.NextNode.LeftNode;

            Connect(root.LeftNode);
            Connect(root.RightNode);
        ...
        static void Main(string[] args)
        {
            ...
            var result = Connect(binaryTree.Root);
